Feature: Quote message formatting
    ...
    Scenario: Multiline blockquote formatting with breaklines
        ...
        And Message has the following HTML content at "last" position in "Message body":
            | html content                                                                                              |
            | <blockquote class="c-mrkdwn__quote">quote line 1<br><br><br>quote line 2<br>quote line 3</blockquote> |
    ...
    Scenario: Two blockquote lines separated with text
        ...
        And Message has the following HTML content at "last" position in "Message body":
            | html content                                                                                                                            |
            | <blockquote class="c-mrkdwn__quote">quote line 1</blockquote>some text<br><blockquote class="c-mrkdwn__quote">quote line 2</blockquote> |
    ...
    Scenario: Do not render next lines as blockquote if starts with spaces
        ...
        And Message has the following HTML content at "last" position in "Message body":
            | html content                                                                                                                         |
            | <blockquote class="c-mrkdwn__quote">quote line 1</blockquote> &gt;not blockquote 1<br>&nbsp;<wbr>&nbsp;<wbr>&gt;not blockquote 2 |
    ...
    Scenario: Preserve spaces inside multiline quote
        And I type "> quote line 1"
        And I press the "Shift + Enter" keyboard button
        And I type ">   quote line 2"
        When I press the "Enter" keyboard button
        ...
        And Message has the following HTML content at "last" position in "Message body":
            | html content                                                                                                                                                      |
            | <blockquote class="c-mrkdwn__quote">&nbsp;<wbr>quote&nbsp;<wbr>line&nbsp;<wbr>1<br>&nbsp;<wbr>&nbsp;<wbr>&nbsp;<wbr>quote&nbsp;<wbr>line&nbsp;<wbr>2</blockquote> |